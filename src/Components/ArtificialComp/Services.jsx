...
export default function Services() {
    return (
      ...
      <div>
        ...
        <div className="hidden sm:block bg-gradient-to-t from-[#E920FF] via-[#9302DA] to-[#6100F8] rounded-r-[5rem] h-98 overflow-hidden">
         <img src="https://i.ibb.co/7XKS6Z9/middle-eastern-cybersecurity-professional.jpg" alt="banner-logo"
