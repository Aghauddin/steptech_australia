  ...
  <div>
    <div className="grid w-full grid-cols-1 gap-12 mx-auto lg:grid-cols-2 mt-10">
      <div className="p-10 flex flex-col justify-center items-center">
        ...
        Impeccable <span className="text-[#D000E7]">Artificial Intelligence Development Company</span> in Australia
        </h1>
        <p className="mx-auto text-base leading-relaxed text-white text-3xl lg:text-2xl sm:text-3xl 2xl:text-4xl">Make your business processes strict, accelerated, and profoundly effective by hiring <b>AI developers</b> for various <b>AI development services</b></p>
      </div>
      <div className="hidden sm:block bg-gradient-to-b from-[#E920FF] via-[#9302DA] to-[#6100F8] rounded-l-[5rem] h-98 overflow-hidden">
     <img src="https://i.ibb.co/Gkg4Drk/2.jpg" alt="banner-logo"
