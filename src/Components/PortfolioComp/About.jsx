export default function About() {
  return (
<section className="relative mx-auto max-w-full px-4 sm:static sm:px-6 lg:px-8 bg-g-purple">
<div>
  <div className="grid w-full grid-cols-1 gap-12 mx-auto lg:grid-cols-2">
    ...
    <div className="inline-flex items-center justify-center flex-shrink-0 md:h-full h-[300px] lg:h-[400px] w-full mx-auto mb-5 bg-transparent rounded-xl">
        <img className="h-full sm:h-full lg:h-full md:h-full object-cover object-center z-10 rounded-full mt-16 ml-8" src="https://i.ibb.co/smBz5yW/Ellipse-1.png"  alt="" />     
        <img className='h-full lg:h-full object-cover -ml-72 lg:-ml-97 z-40' src='https://i.ibb.co/xYQsYg6/Group-4-1.png' alt=''/>
      </div>
    </div>
