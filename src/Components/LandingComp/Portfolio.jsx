...
<div className="relative mx-auto max-w-full px-4 sm:static sm:px-6 lg:px-8">
            <div className="sm:max-w-full lg:max-w-full flex justify-center items-center">
              <h1 className="mt-24 mb-10 font-bold tracking-tight text-4xl lg:text-4xl sm:text-6xl capitalize text-transparent bg-clip-text bg-gradient-to-r from-[#A6A6DF] via-[#A6A6DF] to-[#FFFFFF]">
              portfolio
              </h1>
              </div>
  <div className="hidden lg:block">
    <div className="grid w-full grid-cols-1 gap-12 mx-auto lg:grid-cols-2 mt-10 ">
      ...
      <div className="p-2">
      <div className="inline-flex items-center justify-center flex-shrink-0 h-5/6  lg:h-5/6 sm:h-full mx-auto mb-5 bg-transparent border-13 border-[#9F9FDD] rounded-xl overflow-hidden md:overflow-visible">
          <img className='md:translate-x-12 md:-translate-y-12 delay-200 ease-in-out duration-300 md:hover:translate-x-0 md:hover:-translate-y-0' src='https://i.ibb.co/NCy2211/Mockup-1-stylista-01.png' alt=''/>
        </div>
      </div>
      <div className="p-2 lg:my-10 sm:my-0">
