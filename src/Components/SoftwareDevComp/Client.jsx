    ...
    return (
      ...
      <div>
        <div className="grid w-full grid-cols-1 gap-12 mx-auto lg:grid-cols-2">
         ...
         <img src="https://i.ibb.co/B3znP0P/software-developer-working-new-user-interface-with-online-system-create-algorithm-it-agency-office-s.jpg" alt="banner-logo"
